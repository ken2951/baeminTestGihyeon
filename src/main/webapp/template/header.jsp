	...
	<div id="top_menu_area">
		<div id="top_logo">
			<a href="/finalproject/index">
				<img src="../img/logo.png" alt="코코넛 문방구" style="width:130px; height:48px;"/>
			</a>
		</div><!-- top_logo 끝 -->
				...
				<tbody>
					<tr>
						<td class="catebar"><!-- 카테고리:펼쳐지는 부분 -->
							<div>
								<a href="#" id="main_cate" class="cate1">카테고리</a>
							</div>
							<div>
								<div class="subLayer" style="display:none;">
									<ul class="cate_detail">
										<li><a href="#" class="cate2">문구</a></li>
										<li><a href="#" class="cate2">리빙</a></li>
										<li><a href="#" class="cate2">여행</a></li>
										<li><a href="#" class="cate2">콜라보레이션</a></li>
									</ul>
								</div>
							</div>
						</td><!-- catebar 끝 -->
						...
						<td><!-- 깜짝세일 -->
							<div>
								<a href="#" class="cate1">깜짝세일</a>
							</div>
						</td>
						<td><!-- 잘나가요 -->
							<div>
								<a href="#" class="cate1">잘나가요</a>
							</div>
						</td>
						<td><!-- 문방구연구소 -->
							<div>
								<a href="#" class="cate1">문방구연구소</a>
							</div>
						</td>
		...
		<ul id="top_menu" class="utilMenu">
			<li><a href="#" class="utilMenuText">로그인</a></li>
			<li><a href="#" class="utilMenuText">회원가입</a></li>
			<li><a href="#" class="utilMenuText">장바구니</a></li>
			<li><a href="#" class="utilMenuText">마이페이지</a></li>
		</ul>
